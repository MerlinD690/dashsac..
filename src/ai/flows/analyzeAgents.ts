...
const analysisPrompt = ai.definePrompt({
  ...
  prompt: `Você é um analista de dados especialista em performance de contact centers.
    ...
    1.  Calcular o tempo total de pausa para cada atendente. Some a duração de todos os registros de pausa para cada um.
    ...
    Responda estritamente no formato JSON definido pelo esquema de saída. Calcule o tempo de pausa em minutos e arredonde para duas casas decimais.`,
});
